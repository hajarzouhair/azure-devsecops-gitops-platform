...
│   └── troubleshooting.md                  # Real debugging log (17 incidents)
│   └── screenshots
├── k8s/
│   ├── base/
│   │   ├── deployment.yaml
...
### CI/CD Pipeline
![Pipeline complet](docs/screenshots/pipeline/pipeline1.png)

### GitOps — ArgoCD
![Application Synced/Healthy](docs/screenshots/argocd/application_state.png)

### Observability — Prometheus
![Targets UP](docs/screenshots/prometheus/target_health.png)
![Alertes chargées](docs/screenshots/prometheus/rule_health.png)

### Observability — Grafana
![Dashboard applicatif](docs/screenshots/grafana/dashboard.png)

### Infrastructure
![Ensemble des ressources du cluster](docs/screenshots/terminal/01-all-pods-running.png)
![Azure Cost Management](docs/screenshots/azure/01-cost-management-overview.png)
